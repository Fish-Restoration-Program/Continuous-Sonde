...
xSite <- names(list_all_2022)[-c(3,7)]
...
for(i in 1:length(xSite)){
  ...
  ggsave(paste("ContinuousWQ_DWR_CDFW",xSite[i],".png",sep = ""), multi_plo, width = 625, height = 800, dpi = 96, units = "px")
  } else {
...
save(list_all_QC7, xSite, xVar, file = here::here("final","QCd2_Data_DWR_CDFW.RData"))
```
