...
colnames(df_DECKUSGS)[3:10] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","turb","turb_flag")
...
colnames(df_Toland)[3:10] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","turb","turb_flag")
...
colnames(df_ToeDrain)[3:10] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","turb","turb_flag")
