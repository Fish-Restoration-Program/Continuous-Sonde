...
for(i in 1:length(xSite)){
  ...
  names(list_plo) <- xVar
  # This ifelse statement allows CDFW sites to plot all variables except pH while DWR sites plot all variables except Chl, PC, and fDOM. Starting in 2024, DWR sites will have Chl and PC
  if(xSite[i] %in% c("FLYW", "DECK_Pool","DECK_Breach")){
