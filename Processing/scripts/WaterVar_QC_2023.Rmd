...
xSite <- names(list_all_2023)[-c(3,4,12)]
...
for(i in 1:length(xSite)){
  ...
  #varFlags <- data.frame(xVar, xFlag = c(unique(df_ts$TempC_qcE), unique(df_ts$DOmgL_qcE), unique(df_ts$SPC_qcE), unique(df_ts$ChlRFU_qcE), unique(df_ts$PCRFU_qcE), unique(df_ts$fDOMRFU_qcE),unique(df_ts$TurbRFU_qcE),unique(df_ts$pHRFU_qcE)))
