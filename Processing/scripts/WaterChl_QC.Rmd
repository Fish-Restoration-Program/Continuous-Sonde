...
temp_H_0 <- temp_H[,c("Site","dts","ChlRFU","date","hour","minute")]
...
rm(temp_H_0, df_ts, list_all_2022)
...
temp_q1 <- temp_H %>% mutate(Flag_QC1 = ifelse(Temp<0.1 | Temp>100, "Y", "N")) 
...
temp_q4_c <- temp_q4_a %>%
    group_by(Station) %>%
    time_decompose(Temp, method = "stl", trend = "1 week") %>%
