...
save(allRatings, list_ratings, file = here::here("working","SensorRatings240701.RData"))
```
...
plo_ratings <- ggplot(allRatings[-which(is.na(allRatings$Rating_final)==TRUE),], aes(x = dateRecov, y = Rating_final2)) + 
  geom_point() + 
