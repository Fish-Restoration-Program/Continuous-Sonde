...
df_DECKUSGS <- siteAll[,c(2,3,14,15, # 14 and 15 are DO and its QC status
...
colnames(df_DECKUSGS)[3:14] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","fdom","fdom_flag","chl","chl_flag","turb","turb_flag")

save(df_DECKUSGS, file = here::here("working", "ExtPrograms", "USGS_Toland.RData"))
```
