...
temp_H_0 <- temp_H[,c("Site","dts","DO_mgL","date","hour","minute")]
...
temp_q1 <- temp_H %>% mutate(Flag_QC1 = ifelse(Temp<0, "Y", "N")) 
...
DO_final <- temp_final
save(DO_final, file = "AllLTM4AnalysisQC_DOqc_221230.RData")
```
