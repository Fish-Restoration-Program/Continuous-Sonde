...
df_DECKUSGS.2 <- df_DECKUSGS[which(df_DECKUSGS$dateTime < as.POSIXct(strptime(range(df_Toland$dateTime, na.rm = T)[1], format = "%Y-%m-%d %H:%M:%S", tz = "UTC"))),]
