...
colnames(df_VanSickle)[3:18] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","fdom","fdom_flag","chl","chl_flag","turb","turb_flag", "pH","pH_flag","gage","gage_flag")
...
colnames(df_ToeDrain)[3:18] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","fdom","fdom_flag","chl","chl_flag","turb","turb_flag", "pH","pH_flag","gage","gage_flag")
...
colnames(df_Liberty)[3:18] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","fdom","fdom_flag","chl","chl_flag","turb","turb_flag", "pH","pH_flag","gage","gage_flag")
...
colnames(df_Grizzly)[3:16] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","fdom","fdom_flag","chl","chl_flag","turb","turb_flag", "pH","pH_flag")
...
colnames(df_RushRanch)[3:18] <- c("do","do_flag","tempC","tempC_flag","sc","sc_flag","fdom","fdom_flag","chl","chl_flag","turb","turb_flag", "pH","pH_flag","gage","gage_flag")

save(df_Beldens, file = here::here("working", "ExtPrograms", "ExtProg_2023", "USGS_RushRanch.RData"))
```
...
list_all <- list(df_ToeDrain, df_Liberty, df_Toland, df_VanSickle, df_RushRanch, df_Grizzly)
names(list_all) <- c("Toe Drain","Liberty Island","Toland Landing", "Van Sickle", "Rush Ranch", "Grizzly Bay")
...
multi_plo <- ggarrange(list_plo[[1]], list_plo[[2]], list_plo[[3]], list_plo[[4]], list_plo[[5]], list_plo[[6]],
                         ncol = 6, nrow = 1,
