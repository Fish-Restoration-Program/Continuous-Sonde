...
temp_H_0 <- temp_H[,c("Site","dts","fDOMRFU","date","hour","minute")]
...
temp_q1 <- temp_H %>% mutate(Flag_QC1 = ifelse(Temp<1 | Temp>100, "Y", "N")) 
...
temp_q4_c <- temp_q4_a %>%
    group_by(Station) %>%
    time_decompose(Temp, method = "stl", trend = "15 days") %>%
